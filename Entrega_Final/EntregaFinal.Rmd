...
A.1) Explorar la confianza promedio de cada participante en base al desempeño en la tarea. Por el procedimiento en escalera deberian tener una precision (proporcion de respuestas correctas) del 0.72. Que ambas variables esten en un mismo grafico.
```{r}

...
ecme_sombrero_n50 <- sum(sqrt(muchos_cuantiles_exponenciales_sombrero- qreal)) / length(muchos_cuantiles_exponenciales_sombrero)
ecme_rulo_n50 <- sum(sqrt(muchos_cuantiles_exponenciales_rulo- qreal)) / length(muchos_cuantiles_exponenciales_rulo) ### error!! corregir
